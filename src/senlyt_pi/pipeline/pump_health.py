...
v2.0.0 control-module 결(EP-08/CR-07): 자가진단 통과 전엔 제조 트래픽 보류(fail-closed·토출 0).
...
def auto_pump_map(
    ...
    *,
    ...
    모든 펌프는 같은 스트로크(sy01b 12000)·모드 용량. id(주소)가 곧 pump_map 키다.
    서버 CHANNEL_PUMP_MAP(channel→addr)이 채널 의미를 얹는다 — 여기선 물리 매핑만.
    """
